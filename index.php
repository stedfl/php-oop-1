...
class Movie {
   ...
   */
   ...
   public function set_Description() {
    $this->description = "Il film " . $this->original_title . " è stato realizzato nel " . $this->year . ". Si tratta di un film di genere " . $this->genre;
   }
}

$movie_1 = new Movie("La Leggenda del pianista sull'oceano", "drammatico", 1998, "The Legend of 900" );
$movie_1->set_Poster("https://m.media-amazon.com/images/I/71aWiw3TB-L._AC_SL1200_.jpg");
$movie_1->set_Description();

$movie_2 = new Movie("Moulin Rouge", "musicale", 2001);
